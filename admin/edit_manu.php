...
if(isset($_GET['manu']))
{
    ...
    $itemById = $manufactureModel->getManuById($id);
}
...
{
    $name = $_POST['name'];
    $upload = './images/' . $_FILES['fileUpload']['name'];
    if(is_uploaded_file($_FILES['fileUpload']['tmp_name']) && move_uploaded_file($_FILES['fileUpload']['tmp_name'], $upload))
    {
        $manuModel = new Manufacture();
        if($manuModel->updateManu($name, $_FILES['fileUpload']['name'], $_SESSION['idManu']))
        {
                    ...
                    <div class="span12">
                        <div class="widget-box">
                            ...
                            <div class="widget-content nopadding">
                                ...
                                <!-- BEGIN USER FORM -->
                                <form action="edit_manu.php" method="post"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span11"
                                                ...
                                                name="name"
                                                value="<?php echo $itemById['manu_name']?>" /> *
                                            <img style="width:100px"
                                                src="./images/<?php echo $itemById['manu_image']?>"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="control-group">

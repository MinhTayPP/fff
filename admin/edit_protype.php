...
{
    $id = $_GET['protype'];
    $_SESSION['idProtype'] = $id;
    $protypeModel = new Protype();
    $itemById = $protypeModel->getProtypeById($id);
}
...
if(isset($_POST['name']))
{
    ...
    {
        $protypeModel = new Protype();
        if($protypeModel->updateProtype($name, $_FILES['fileUpload']['name'], $_SESSION['idProtype']))
        {
                    ...
                    <div class="span12">
                        <div class="widget-box">
                            ...
                            <div class="widget-content nopadding">
                                ...
                                <!-- BEGIN USER FORM -->
                                <form action="edit_protype.php" method="post"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span11"
                                                ...
                                                name="name"
                                                value="<?php echo $itemById['type_name']?>" /> *
                                            <img style="width:100px"
                                                src="./images/<?php echo $itemById['type_image']?>"
                                                alt="">
                                        </div>
                                    </div>
                                    <div class="control-group">

...
$perpage = 5;
$product = new Product();
// $productList = $product->getAllProducts($page, $perpage);
// $totalPage = ceil($product->getTotalAllProducts() / $perpage);
                    ...
                    <div class="span12">
                        <div class="widget-box">
                            <div class="widget-title"> <span class="icon"><a
                                        href="form.php"> <i class="icon-plus"></i>
                                    </a></span>
                                <h5>Products</h5>
                            </div>
                                ...
                                <table class="table table-bordered
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="">
                                            <td width="250">
                                                <img
                                                    src="./images/<?php echo $item['pro_image']?>"
                                                    />
                                            </td>

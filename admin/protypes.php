...
$protypeList = $protypeModel->getAllProtypes();
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-content nopadding">
                                <table class="table table-bordered
                                    ...
                                    <tbody>
                                        <?php
                                            foreach($protypeList as $item) :
                                        ?>
                                        <tr class="">
                                            <td width="100"><img
                                                    src="./images/<?php echo $item['type_image']?>"></td>
                                            <td><?php echo $item['type_name']?></td>

                                            <td>
                                                <a href="edit_protype.php?protype=<?php echo $item['type_id']?>" class="btn
